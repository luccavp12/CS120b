 ...
 *
 *  ******NOTICE*******
 *  I had to film the video from the other side of my board because the wires were in the way of the
 *  camera, so the LEDs look flipped
 *  ******NOTICE*******
 *  Video Link: https://www.youtube.com/watch?v=arx3Te_ttpI
 * 
 * 
 */
